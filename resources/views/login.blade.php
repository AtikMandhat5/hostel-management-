...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <script src="{{ asset('/assets/js/demo1/pages/validate/validate.js') }}" type="text/javascript"></script>
...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
    ...
    <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v1" id="kt_login">
      <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
        ...
        <div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url({{ asset('/assets/media/bg/bg-4.jpg') }}">
          ...
          <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
            <!-- <div class="kt-grid__item kt-grid__item--middle"> -->
              <h3 class="kt-login__title">RKU | HostelManagement</h3>
        ...
        <div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
          ...
          <div class="kt-login__body">
            ...
            <div class="kt-login__form">
              ...
              <div class="alert alert-danger error_div" role="alert" style="display: none;">
                <div class="alert-icon"><i class="flaticon-warning"></i></div>
                <div class="alert-text">Invalid Email or Password..!</div>
              </div>

              <!--begin::Form-->
              <form class="kt-form login_form" method="post">
                @csrf
                ...
                <div class="kt-login__actions">
                  ...
                  <a type="button" href="dashbord" id="kt_login_signin_submit" class="btn btn-danger btn-elevate kt-login__btn-primary sign_in">Sign In</a>
  ...
  <script src="{{ asset('/assets/js/demo1/pages/pageJS/welcome.js') }}" type="text/javascript"></script>
